...
import maid_service.admin.AdminFrame;
import maid_service.admin.AdminClass;
import maid_service.maid.LoginMaid;
import maid_service.maid.MaidClass;
import maid_service.maid.MaidFrame;
import maid_service.maid.MyAccount2;
import maid_service.user.LoginUser;
import maid_service.user.userclass;
...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void signinbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signinbuttonActionPerformed
        ...
        if (con == null) {
            ...
            //user frame
            String sql = "SELECT * FROM `user`  where nid = '" + nidfield.getText() + "'and password ='" + passwordfield.getText() + "'";
            //maid frame
            String sqll = "SELECT * FROM `maid`  where nid = '" + nidfield.getText() + "'and password ='" + passwordfield.getText() + "'";
            //admin frame
            String sqlll = "SELECT * FROM `admin`  where nid = '" + nidfield.getText() + "'and password ='" + passwordfield.getText() + "'";
            if (null == k) {
                    ...
                    case "Maid":
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                String workinghours = rs.getString(9);
                                MaidClass.workinghours = workinghours;
                                MyAccount2 my = new MyAccount2();
                                my.setVisible(true);
                                this.setVisible(false);
